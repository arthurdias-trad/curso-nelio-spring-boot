...
import br.com.arthurdias.cursomc.services.CategoriaService;
...
public class CategoriaResource {
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody CategoriaDTO obj) {
		Categoria cat = this.service.fromDTO(obj);
	...
	public ResponseEntity<Page<CategoriaDTO>> findPage(
		...
		Page<CategoriaDTO> pageDTO = service.findPage(page, linesPerPage, orderBy, direction);
